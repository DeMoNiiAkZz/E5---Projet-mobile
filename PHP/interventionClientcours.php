        ...
        case 'GET':
            if (isset($_GET['id_client'])) {
                ...
                $sql = "SELECT 
                            ...
                            fichier.chemin AS chemin_photo_technicien
                        FROM 
                            intervention
                        JOIN 
                        ...
                        LEFT JOIN
                            fichier ON fichier.id_fichiers = utilisateur.id_fichier
                        WHERE 
                            intervention.statut IN ('En cours', 'A faire' , 'Reporté') AND intervention.id_client = :id_utilisateur;";
                ...
                foreach ($interventions as &$intervention) {
                    ...
                    if ($intervention['chemin_photo_technicien']) {
                        $intervention['chemin_photo_technicien'] = $intervention['chemin_photo_technicien']; 
                    }
